...
ActiveRecord::Schema.define(version: 20170308220605) do
  ...
  create_table "logo_ratings", force: :cascade do |t|
    t.integer  "logo_id"
  ...
  create_table "ogt_photos", force: :cascade do |t|
  ...
  create_table "organizational_rewards", force: :cascade do |t|
  ...
  create_table "organizational_tasks", force: :cascade do |t|
    t.integer  "organization_id"
    t.integer  "task_id"
  ...
  create_table "volunteer_activity_logs", force: :cascade do |t|
    t.integer  "volunteer_id"
    t.integer  "task_id"
    t.datetime "created_at"
    t.datetime "updated_at"
